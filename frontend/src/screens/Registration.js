...
function Registration() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:8000/createuser/register", {
        method: 'POST',
        headers: {
                      ...
                      <form className="mx-1 mx-md-4" onSubmit={handleSubmit}>
                        <div className="d-flex flex-row align-items-center mb-4">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            <input type="text" id="form3Example1c" className="form-control" name="username" value={credentials.username.trim()} onChange={onChange} />
                        ...
                        <div className="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                          ...
                          <Link to="/login" className="btn btn-link btn-lg small fw-bold mt-2 pt-1 mb-2">Already a user?</Link>
                        </div>
                      </form>
                    </div>
